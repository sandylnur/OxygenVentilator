...
// function to get the potentiometer input "potentioOne" "potentioTwo"
  int getPotInput(String potentiometer) {
      if (potentiometer == "bpm_in") {
        ...
        //  values divided into (0 to 19, 20 to 39 .......) and return a string Variable as "PresetOne", "PresetTwo", ...  
          if (potMappedValueThree <= 0 && potMappedValueThree < 20){
            return 1;
          }  
          if (potMappedValueThree <= 20 && potMappedValueThree < 40){
            return 2;
          }
          if (potMappedValueThree <= 40 && potMappedValueThree < 60){
            return 3;
          }
          if (potMappedValueThree <= 60 && potMappedValueThree < 80){
            return 4;
          }
          if (potMappedValueThree <= 80 && potMappedValueThree < 100){
            return 5;
          }
      }
  }
